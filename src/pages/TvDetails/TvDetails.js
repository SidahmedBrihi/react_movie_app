...
const TvDetails = () => {
    ...
    fetch(`https://api.themoviedb.org/3/tv/${movieId}?api_key=fb4004e564486b55dac55698ceaa8be4&language=en-US`)
    .then(val => val.json() )
    .then(val => {
        setMovie(val)
        setCateg(val.genres)
    ...
    fetch(`https://api.themoviedb.org/3/tv/${movieId}/credits?api_key=fb4004e564486b55dac55698ceaa8be4&language=en-US`)
    .then(val => val.json() )
    .then(val => {
